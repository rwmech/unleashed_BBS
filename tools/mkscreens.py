...
SETUP80 = [
    [   ("t", "YOU ARE THE SYSOP"),
        ...
        ("b", "The Sysop row's stars are the published default: change it now. Type"),
        ("i", "your own straight over them, no need to delete them first."),
        ("b", "Co-sysop 1 and 2: leave them blank unless you want helpers. A blank"),
        ("i", "level is one nobody can use."),
        ("", ""),
        ("n", "CLOSED UNTIL YOU OPEN IT"),
        ("d", "Callers get a closed sign until you open the board: `CONFIG board`, then"),
        ("d", "Stop taking calls, set to no. Do that after the passwords and settings."),
        ("", ""),
        ("n", "WHAT HAPPENS NEXT"),
...
SETUP40_FORM_PET = [
    ...
    ("i", "Sysop's stars: the published default."),
    ("i", "Type your own straight over them."),
    ("i", "Co-sysop 1 and 2: blank unless you"),
    ("i", "want helpers. Blank means nobody can"),
    ("i", "use that level."),
]
SETUP40_FORM_ASC = [
    ("i", "One question a line: type the new"),
    ("i", "password and press Enter. The sysop"),
    ("i", "one is the published default now:"),
    ("i", "change it. Answer Y at the end."),
    ("i", "Co-sysop 1 and 2: blank unless you"),
    ("i", "want helpers. Blank means nobody can"),
    ("i", "use that level."),
]
SETUP40_TAIL = [
    ("", ""),
    ("d", "Callers see a closed sign until you"),
    ("d", "open it: CONFIG board, last row, no."),
    ("d", "Next: the form, then a short tour."),
]
...
NEWSYSOP80 = [
    ...
    [   ("t", "SETTING UP YOUR BOARD"),
        ...
        ("", ""),
        ("n", "OPENING UP"),
        ("d", "Callers get a closed sign until `CONFIG board` sets Stop taking calls to no."),
...
NEWSYSOP40 = [
    ...
    [   ("n", "THE CARD"),
        ...
        ("", ""),
        ("n", "OPENING UP"),
        ("d", "Callers see a closed sign until"),
        ("d", "`CONFIG board`'s last row says no."),
        ("d", "`CONFIG announce` lists the board in"),
        ("d", "the public directory, off until you"),
        ("d", "switch it on. Port forwarding last."),
        ("", ""),
        ("n", "STAFF COMMANDS"),
